...
function exportToCSV(trades) {
    ...
    const rows = trades
        ...
        .map(t => {
            const dateStr = t.closedTs ? new Date(t.closedTs + IST_OFFSET_MS).toISOString().slice(0, 10) : "";
    ...
    if (!status)
        return (
            <div className="settings-group">
                <p className="diag-hint">Loading status…</p>
            </div>
        );
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
                    <div
                        className={`conn-status-btn ${
                            config?.enabled ? "conn-status-btn--green" : "conn-status-btn--red"
                        }`}
                    ...
                    >
                        <span
                            style={{
                                ...
                                height: 7,
                                borderRadius: "50%",
                                background: sseConnected ? "#51cf66" : "#ff6b6b",
                ...
                <div style={{ display: "flex", gap: 12, alignItems: "center", fontSize: 12, flexWrap: "wrap" }}>
                    ...
                    <label
                        style={{
                            ...
                            color: config?.maskPatternNames ? "#4dabf7" : "var(--text-secondary)"
                        }}
                    >
                        <input
                            type="checkbox"
...
function ConfigPanel({ config, onUpdateConfig }) {
                ...
                >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="0.5"
                            max="5"
                            value={config.minRR ?? 2.5}
                            onChange={e => onUpdateConfig({ minRR: parseFloat(e.target.value) || 2.5 })}
                            style={{
                                width: "100%",
                                padding: "6px 10px",
                                fontSize: 13,
                        ...
                        />
                        <span style={{ fontSize: 10, color: "var(--text-muted)" }}>Skip trades below this R:R</span>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="1"
                            max="10"
                            value={config.maxPatternTrades ?? 4}
                            onChange={e => onUpdateConfig({ maxPatternTrades: parseInt(e.target.value) || 4 })}
                            style={{
                                width: "100%",
                                padding: "6px 10px",
                                fontSize: 13,
                        ...
                        />
                        <span style={{ fontSize: 10, color: "var(--text-muted)" }}>Max concurrent pattern trades</span>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="1"
                            max="50"
                            value={config.niftyLots ?? 3}
                            onChange={e => onUpdateConfig({ niftyLots: parseInt(e.target.value) || 3 })}
                            style={{
                                width: "100%",
                                padding: "6px 10px",
                                fontSize: 13,
                        ...
                        />
                        <span style={{ fontSize: 10, color: "var(--text-muted)" }}>Lot size for NIFTY trades</span>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="1"
                            max="50"
                            value={config.sensexLots ?? 5}
                            onChange={e => onUpdateConfig({ sensexLots: parseInt(e.target.value) || 5 })}
                            style={{
                                width: "100%",
                                padding: "6px 10px",
                                fontSize: 13,
                        ...
                        />
                        <span style={{ fontSize: 10, color: "var(--text-muted)" }}>Lot size for SENSEX trades</span>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="50"
                            max="95"
                            value={config.tslTriggerPct ?? 50}
                            onChange={e => onUpdateConfig({ tslTriggerPct: parseInt(e.target.value) || 50 })}
                            style={{
                                width: "100%",
                                padding: "6px 10px",
                                fontSize: 13,
                        ...
                        <span style={{ fontSize: 10, color: "var(--text-muted)" }}>
                            Activate TSL at this % of target
                        </span>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="50"
                            max="95"
                            value={config.tslTrailPct ?? 70}
                            onChange={e => onUpdateConfig({ tslTrailPct: parseInt(e.target.value) || 70 })}
                            style={{
                                width: "100%",
                                padding: "6px 10px",
                                fontSize: 13,
                        ...
                        />
                        <span style={{ fontSize: 10, color: "var(--text-muted)" }}>Trail SL at this % of peak</span>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            placeholder="09:20"
                            value={config.tradeStartHHMM ?? "09:20"}
                            onChange={e => onUpdateConfig({ tradeStartHHMM: e.target.value })}
                            style={{
                                width: "100%",
                                padding: "6px 10px",
                                fontSize: 13,
                        ...
                        />
                        <span style={{ fontSize: 10, color: "var(--text-muted)" }}>No entries before this time</span>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            placeholder="15:15"
                            value={config.tradeEndHHMM ?? "15:15"}
                            onChange={e => onUpdateConfig({ tradeEndHHMM: e.target.value })}
                            style={{
                                width: "100%",
                                padding: "6px 10px",
                                fontSize: 13,
                        ...
                        />
                        <span style={{ fontSize: 10, color: "var(--text-muted)" }}>No entries after this time</span>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            placeholder="15:25"
                            value={config.eodCloseHHMM ?? "15:25"}
                            onChange={e => onUpdateConfig({ eodCloseHHMM: e.target.value })}
                            style={{
                                width: "100%",
                                padding: "6px 10px",
                                fontSize: 13,
                        ...
                        />
                        <span style={{ fontSize: 10, color: "var(--text-muted)" }}>Force close all at this time</span>
                    </div>
                    ...
                    <div>
                        ...
                        >
                            <input
                                type="checkbox"
                                checked={config.tslEnabled ?? true}
                                onChange={e => onUpdateConfig({ tslEnabled: e.target.checked })}
                            />
...
function PnlSummary({ pnl }) {
    ...
    return (
        ...
        >
            <StatBox
                label="Today's PnL"
                value={fmtPnl(pnl.totalPnl)}
                color={pnl.totalPnl >= 0 ? "#51cf66" : "#ff6b6b"}
            />
                                ...
                                return (
                                    <tr key={t.id}>
                                        ...
                                        <td>
                                            ...
                                            {hasAvgdDown && displayAvg != null && (
                                                <div style={{ fontSize: 10, color: "#fab005" }}>
                                                    avg ₹{fmtPrice(displayAvg)}
                                                </div>
                                            )}
                                        </td>
                                        ...
                                        >
                                            {distanceFromSl != null
                                                ? `${distanceFromSl > 0 ? "+" : ""}${distanceFromSl.toFixed(1)}%`
                                                : "—"}
                                        </td>
            ...
            {chartTrade && (
                <ScanChartModal
                    alert={{
                        ...
                        patternLabel:
                            chartTrade.patternLabel ||
                            (chartTrade.strategyType === "low-premium" ? "💰 LP Scalper" : null),
                ...
                <h3 style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 12 }}>
                    ...
                    >
                        ...
                        >
                            {loadingHistory
                                ? "⏳ Loading..."
                                : `📜 All History${historicalTrades.length > 0 ? ` (${historicalTrades.length})` : ""}`}
                        </button>
                    </div>
                        ...
                        <>
                            <span
                                style={{
                                    fontSize: 13,
                                    fontWeight: 600,
                                    color: displayPnl >= 0 ? "#51cf66" : "#ff6b6b"
                                }}
                            >
                                {fmtPnl(displayPnl)}
                            </span>
                ...
                {displayTrades.length === 0 ? (
                    <p className="diag-hint">
                        {viewMode === "today"
                            ...
                            : 'No trades in history. Click "All History" to load from database.'}
                    </p>
                ) : (
                    <div style={{ overflowX: "auto" }}>
                        <table className="diag-table" style={{ fontSize: 12, width: "100%" }}>
                            ...
                            <tbody>
                                {displayTrades.map(t => {
                                    const dateStr = t.closedTs
                                        ? new Date(t.closedTs).toLocaleDateString("en-IN", {
                                              day: "2-digit",
                                              month: "short"
                                          })
                                        : "—";
                                            ...
                                            <td>
                                                <span
                                                    style={{
                                                        ...
                                                        borderRadius: 3,
                                                        background:
                                                            t.exitReason === "target" ? "#51cf6622" : "#ff6b6b22",
...
function AnalyticsSection({ fetchComprehensiveAnalytics, fetchHistoricalTrades }) {
    ...
    return (
        <div className="settings-group">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style={{ textAlign: "right" }}>
                                            {analytics.rsiAnalysis.withRsi?.count || 0}
                                        </td>
                                        <td style={{ textAlign: "right", color: "#51cf66" }}>
                                            {analytics.rsiAnalysis.withRsi?.wins || 0}
                                        </td>
                                        <td style={{ textAlign: "right", color: "#ff6b6b" }}>
                                            {analytics.rsiAnalysis.withRsi?.losses || 0}
                                        </td>
                                        <td style={{ textAlign: "right", fontWeight: 600 }}>
                                            {fmtWinRate(
                                                analytics.rsiAnalysis.withRsi?.wins,
                                                analytics.rsiAnalysis.withRsi?.count
                                            )}
                                        </td>
                                        <td
                                            style={{
                                                ...
                                                fontWeight: 600,
                                                color:
                                                    (analytics.rsiAnalysis.withRsi?.totalPnl || 0) >= 0
                                                        ? "#51cf66"
                                                        : "#ff6b6b"
                                            }}
                                        >
                                    ...
                                    <tr>
                                        ...
                                        <td style={{ textAlign: "right" }}>
                                            {analytics.rsiAnalysis.withoutRsi?.count || 0}
                                        </td>
                                        <td style={{ textAlign: "right", color: "#51cf66" }}>
                                            {analytics.rsiAnalysis.withoutRsi?.wins || 0}
                                        </td>
                                        <td style={{ textAlign: "right", color: "#ff6b6b" }}>
                                            {analytics.rsiAnalysis.withoutRsi?.losses || 0}
                                        </td>
                                        <td style={{ textAlign: "right", fontWeight: 600 }}>
                                            {fmtWinRate(
                                                analytics.rsiAnalysis.withoutRsi?.wins,
                                                analytics.rsiAnalysis.withoutRsi?.count
                                            )}
                                        </td>
                                        <td
                                            style={{
                                                ...
                                                fontWeight: 600,
                                                color:
                                                    (analytics.rsiAnalysis.withoutRsi?.totalPnl || 0) >= 0
                                                        ? "#51cf66"
                                                        : "#ff6b6b"
                                            }}
                                        >
            ...
            {!expanded && !analytics && (
                <p className="diag-hint">
                    Click "Load Analytics" to see pattern performance, timeframe stats, and more.
                </p>
            )}
        </div>
    );
    ...
    return (
        <div style={{ marginBottom: 16 }}>
            ...
            >
                ...
                <span>
                    Spot: <strong style={{ color: "var(--text-primary)" }}>{fmtPrice(spotLtp)}</strong>
                </span>
                ...
                <table className="diag-table" style={{ fontSize: 12, width: "100%", borderCollapse: "collapse" }}>
                    <thead>
                        <tr>
                            ...
                            <th className="idx-ohl-cell" style={{ textAlign: "right", color: "#51cf66", fontSize: 10 }}>
                                Open
                            </th>
                            <th className="idx-ohl-cell" style={{ textAlign: "right", color: "#51cf66", fontSize: 10 }}>
                                High
                            ...
                            <th className="idx-ohl-cell" style={{ textAlign: "left", color: "#ff6b6b", fontSize: 10 }}>
                                Low
                            </th>
                            <th className="idx-ohl-cell" style={{ textAlign: "left", color: "#ff6b6b", fontSize: 10 }}>
                                High
                    ...
                    <tbody>
                        {strikes.map(row => {
                            ...
                            const rowStyle = isAtm ? { background: "rgba(77, 171, 247, 0.1)", fontWeight: 600 } : {};
                            ...
                            return (
                                <tr key={row.strike} style={rowStyle}>
                                    ...
                                    >
                                        {row.strike}
                                        {isAtm && (
                                            <span style={{ fontSize: 9, marginLeft: 4, color: "#4dabf7" }}>ATM</span>
                                        )}
                                    </td>
                                    <td
                                        className="idx-ohl-cell"
                                        style={{ textAlign: "left", fontSize: 11, color: "var(--text-muted)" }}
                                    >
        ...
        <div className="page">
            <div className="page-header" style={{ overflowX: "auto", whiteSpace: "nowrap" }}>
                <div style={{ minWidth: 0 }}>
                    ...
                    <p className="page-sub" style={{ whiteSpace: "nowrap" }}>
                        NIFTY & SENSEX options — ATM ± 5 strikes — auto scan & paper trade
                    </p>
                </div>
            ...
            <div className="settings-panel">
                <StatusBar
                    ...
                    onRefreshStrikes={refreshStrikes}
                ...
                <AnalyticsSection
                    fetchComprehensiveAnalytics={fetchComprehensiveAnalytics}
