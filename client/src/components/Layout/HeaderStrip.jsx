...
export default function HeaderStrip() {
  ...
  useEffect(() => {
    let cancelled = false;
    function load() {
      api.get('/auto-trader/settings').then((r) => {
    ...
    <div className="header-strip">
      <div className="hdr-item">
        ...
        <span className="hdr-sub">
          R {fmtRupee(realized)} · U {fmtRupee(unrealized)}
        </span>
      </div>
      ...
      <div className="hdr-item">
        ...
        <span className="hdr-sub">Σ |entry − SL| × qty</span>
      </div>

      <div className="hdr-divider" />

      <div className="hdr-item">
        <span className="hdr-label">Auto Trader</span>
        <span className={`hdr-value hdr-auto ${autoEnabled ? 'hdr-auto--on' : 'hdr-auto--off'}`}>
      ...
      <div className="hdr-item hdr-item--right">
        <span className={`hdr-mkt-pill ${mkt.cls}`}>{mkt.label}</span>
      </div>
    </div>
  );
}
